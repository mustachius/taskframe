...
`},
	...
	"tuihelp.sort.v":    {"toggle sort (urgency/due/created)", "alternar ordenação (urgência/vencimento/criação)"},
	"tuihelp.theme.v":   {"toggle theme (dark/borland/green/amber)", "alternar tema (dark/borland/green/amber)"},
	"tuihelp.undo.v":    {"undo last operation", "desfazer última operação"},
